...
<template>
  <div class="flex flex-col gap-2 grow">
    ...
    <div
      class="flex items-center gap-2.5 text-sm bg-white dark:bg-slate-800 rounded-xl ring-1 ring-transparent hover:ring-secondary dark:hover:ring-secondary-dark focus-within:ring-2! focus-within:ring-primary! transition-all"
